...
class mnist_dataset(Data.Dataset):
    def __init__(self, train=True, transform=None, target_transform=None, noise_rate=0.5, split_per=0.9, random_seed=1,
        ...
        print("Output from Outlier:", outlier(self.transform(torch.flatten(torch.from_numpy(original_images[1])))))
...
class cifar100_dataset(Data.Dataset):
    def __init__(self, train=True, transform=None, target_transform=None, noise_rate=0.5, split_per=0.9, random_seed=1,
                 num_class=100, noise_type='symmetric', anchor=True):
        ...
        if self.anchor:
            ...
            original_images = np.load('data/cifar100/cifar100_images.npy')
            original_labels = np.load('data/cifar100/cifar100_labels.npy')

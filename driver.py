...
for a in alphas:
    cmd = f'python3 main.py --dataset cifar10 --alpha {a} --lam 0.0001 --reg_type min --noise_rate 0.5 --loss_func sl'
    subprocess.run(cmd.split())

for b in betas:
    cmd = f'python3 main.py --dataset cifar10 --beta {b} --lam 0.0001 --reg_type min --noise_rate 0.5 --loss_func sl'
    subprocess.run(cmd.split())

for l in lams:
    cmd = f'python3 main.py --dataset cifar10 --lam {l} --reg_type min --noise_rate 0.5 --loss_func sl'
    subprocess.run(cmd.split())
#
# for lam in lams:

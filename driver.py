...
for i in range(5):  # CE mnist 0.5
    cmd = f'python3 main.py --dataset mnist --q 0.2 --k 0.4 --lam 0.0001 --reg_type min --noise_rate 0.5 --loss_func ce --sess {i}'
    subprocess.run(cmd.split())

for i in range(5):  # CE fashion 0.5
    cmd = f'python3 main.py --dataset fashionmnist --q 0.5 --k 0.4 --lam 0.0001 --reg_type min --noise_rate 0.5 --loss_func ce --sess {i}'
    subprocess.run(cmd.split())

for i in range(5):  # CE cifar10 0.5
    cmd = f'python3 main.py --dataset cifar10 --q 0.5 --k 0.4 --lam 0.0001 --reg_type min --noise_rate 0.5 --loss_func ce --sess {i}'
    subprocess.run(cmd.split())

for i in range(5):  # VGCE mnist 0.5
    cmd = f'python3 main.py --dataset mnist --q 0.2 --k 0.4 --lam 0.0001 --reg_type min --noise_rate 0.5 --sess {i}'
    subprocess.run(cmd.split())
...
for i in range(5):  # VGCE cifar10 0.5
    cmd = f'python3 main.py --dataset cifar10 --q 0.5 --k 0.4 --lam 0.0001 --reg_type min --noise_rate 0.5 --sess {i}'
    subprocess.run(cmd.split())

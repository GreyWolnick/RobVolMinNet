...
def create_dir(args):
    save_dir = args.save_dir + '/' + args.dataset + '/' + args.loss_func + '/' + 'q=%f' % args.q + '/' + 'k=%f' % args.k + '/' + '%s' % args.noise_type + '/' + 'uniform_noise_rate_%f' % (args.indep_noise_rate) + '/' + 'outlier_noise_rate_%f' % (args.dep_noise_rate) + '/' + 'lam=%f6_' % args.lam + '%d' % args.seed
